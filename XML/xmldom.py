...
# dom - dom trees the xml file is treated as a tree object

domtree = xml.dom.minidom.parse('data.xml')
# group is the root tree
...
# commands to manipulate xml file via dom
...
# Creating New Elements to the xml file
